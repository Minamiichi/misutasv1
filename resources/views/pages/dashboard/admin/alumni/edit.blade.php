                ...
                <div class="card-body">
                    <div class="py-12">
                        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
                            ...
                            @endif
                            <form action="{{ route('dashboard.alumni.update', $alumni->id) }}" class="w-full" method="POST" enctype="multipart/form-data">
                                @csrf
                                @method('PUT')
                                <div class="form-group row">
                                    <div class="col-sm-6 mb-3">
                                        <label for="" class="block uppercase tracking-wide text-gray-700 text-xs font-bold mb-2">No
                                            Ijazah</label>
                                        <input type="text" value="{{ old('no_ijazah') ?? $alumni->no_ijazah }}"
                                    ...
                                    <div class="col-sm-6 mb-3">
                                        <label for="" class="block uppercase tracking-wide text-gray-700 text-xs font-bold mb-2">Tanggal
                                            Lulus</label>
                                        <input type="date" value="{{ old('graduate') ?? $alumni->graduate }}" name="graduate" class="form-control form-control-user"
                                ...
                                <div class="form-group row">
                                    <div class="col-sm-6 mb-3">
                                        ...
                                        <input type="text" name="nisn" value="{{ old('nisn') ?? $alumni->nisn }}"  class="form-control form-control-user">
                                    </div>
                                    <div class="col-sm-6 mb-3">
                                        <label for="" class="block uppercase tracking-wide text-gray-700 text-xs font-bold mb-2">Nama</label>
                                        <input type="text" name="name" value="{{ old('name') ?? $alumni->name }}"  class="form-control form-control-user">
                                    </div>
                                    <div class="col-sm-6 mb-3">
