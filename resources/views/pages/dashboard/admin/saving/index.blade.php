...
<div class="container-fluid">
    ...
    <!-- Page Heading -->
    <h1 class="h3 mb-2 text-gray-800">Data Tabungan</h1>
    ...
    <div class="card shadow mb-4">
        ...
        <div class="card-body">
            <div class="table-responsive">
                    ...
                    <tbody>
                        @foreach ($savings as $saving)
                            <tr>
                                ...
                                <td>{{ $saving->day }}, {{ $saving->date }}</td>
                                <td>{{ $saving->sum }}</td>
                                <td><a href="{{ route('dashboard.saving.edit', $saving->id) }}" class="bg-green-500 hover:bg-green-700 text-white font-bold py-2 px-4 rounded shadow-lg">
                                    + Create Class
                                </a>
                ...
                <button class="btn btn-primary">
                    <a href="{{ route('dashboard.saving.create') }}" class="bg-green-500 hover:bg-green-700 text-white font-bold py-2 px-4 rounded shadow-lg">
                        + Create Class
                    </a>
                </button>
            </div>
